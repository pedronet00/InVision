                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                ...
                                <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Imprimir Relatório</a>
                            </div>
                                                        ...
                                                        <div class="col">
                                                            <div class="progress progress-sm mr-2">
                                                                <div class="progress-bar bg-info" role="progressbar"
                                                                    style="width: <?php echo $taskDonePercent; ?>%" aria-valuenow="<?php echo $taskDonePercent; ?>" aria-valuemin="0" aria-valuemax="100">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3" style="background-color: #6875f5; color: white;">
                                            <h6 class="m-0 font-weight-bold">Total de Projetos por Time</h6>
                                        </div>
                                        <div class="card-body">
                                            @foreach ($projectsByTeam as $teamName => $data)
                                                <h4 class="small font-weight-bold">{{ $teamName }} <span class="float-right">{{ $data['raw_count'] }}</span></h4>
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @if ($totalProjects <= 5)
                                                <p>Você está apenas começando. Continue cadastrando mais projetos!</p>
                                            @elseif ($totalProjects <= 10)
                                                <p>Você está em um nível intermediário de cadastro. Continue assim!</p>
                                            @else
                                                <p>Você já cadastrou muitos projetos. Parabéns!</p>
                                            @endif
                                        </div>
                                    </div>
                                </div>
